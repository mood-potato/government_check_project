# backend/modules/extract/congress_schedule_extractor.py
from backend.modules.base.base_extractor import BaseExtractor
from backend.modules.utils.request_utils import request_paginated_data
from backend.modules.utils.config import OPEN_GOVERMENT_API_KEY
